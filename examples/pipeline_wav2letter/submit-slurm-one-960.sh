...
#SBATCH --output=/checkpoint/%u/jobs/wav2letter-%j.out
#SBATCH --error=/checkpoint/%u/jobs/wav2letter-%j.err
...
CMD="python /private/home/vincentqb/audio/examples/pipeline_wav2letter/main.py \
    ...
    --checkpoint /checkpoint/vincentqb/checkpoint/wav2letter-$SLURM_JOB_ID.pth.tar"
